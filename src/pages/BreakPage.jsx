  ...
  return (
    <SafeAreaView style={styles.screen}>
      ...
      <View style={styles.card}>
        <Image source={require("../assets/images/frog-two.gif")} style={styles.frogImage} resizeMode="contain" />

        <View style={styles.modeRow}>
          <Pressable
            style={({ pressed }) => [styles.pillButton, styles.inactiveModeButton, pressed && styles.pressed]}
            onPress={() => navigate("/focus")}
          >
            <Text style={styles.pillText}>FOCUS</Text>
          </Pressable>
          <Pressable
            style={({ pressed }) => [styles.pillButton, styles.activeModeButton, pressed && styles.pressed]}
        ...
        <Text style={styles.message}>Time to relax~</Text>
